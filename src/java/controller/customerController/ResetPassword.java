...
public class ResetPassword extends HttpServlet {
    ...
    public String checkPassword(String password) {
        ...
        if (!password.matches(regexPassword)) {
            message2 = "Password must have at least one numeric character, one lowercase character, one uppercase character,  8 - 20 characters";
            return message2;
        }
        return null;
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String passwordConvert = encrypt.toSHA1(confPassword);
        ...
        if (message2 != null || message3 != null) {
            ...
            if (dbc.getAccByEmail(email) != null) {
                dbc.resetPassword(email, passwordConvert);
            }
