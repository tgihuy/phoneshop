                        ...
                        <div class="table-responsive">
                            <form method="post" action="ProductUpdate" enctype="multipart/form-data">
                                ...
                                <select required name="category" class="select">
                                    <c:forEach items="${requestScope.categories}" var="b">
                                ...
                                <div class="form-outline">
                                    ...
                                    <input name="images" class="form-control" type="file" id="formFileMultiple" value="${requestScope.product.getProductImage().getUrl()}" />
                                </div>
