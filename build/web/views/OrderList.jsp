...
<html>
    <head>
        ...
        <link href="css/formmargin.css" rel="stylesheet">
        ...
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3" >
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="OrderList" class="nav-item nav-link active">Order List</a>
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                    ...
                    <form id="orderByFrm" action="OrderList" method="get" class="d-none d-md-flex ms-4">
                        <input class="form-control border-0" name="search" value="${search}" type="search" placeholder="Search">

                        Order By:<select id="mySelect" class="form-control" name="orderby">
                            <option >All</option>
                            <option value="total" ${orderby=="total"?"selected":""}>Total</option>
                            <option value="date" ${orderby=="date"?"selected":""}>Date</option>
                            <option value="customerName" ${orderby=="customerName"?"selected":""}>Customer Name</option>
                        </select>
                    </form>
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">Order Manager</h6>
                        </div>
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <c:forEach items="${sessionScope.orders}" var="o" begin="${(pagination.getCurrentPage()-1)*pagination.getPerPage()}" end="${(pagination.getCurrentPage()*pagination.getPerPage()-1)<0?0:(pagination.getCurrentPage()*pagination.getPerPage()-1)}" >
                                        <tr>
                                            <td>${o.getOrderID()}</td>
