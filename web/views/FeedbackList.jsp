            ...
            <div class="sidebar pe-4 pb-3" >
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="BlogSettings" class="nav-item nav-link">Blog Management</a>
                        <a href="FeedbackList" class="nav-item nav-link active">Feedback List</a>
                    ...
                    <div class="bg-light text-center rounded p-4">
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <c:forEach items="${sessionScope.feedbacks}" var="f" begin="${(pagination.getCurrentPage()-1)*pagination.getPerPage()}" end="${pagination.getCurrentPage()*pagination.getPerPage()-1}">
                                        <tr>
                                            <td></td>
                                            <td>${f.getProduct().getProductName()}</td>
                                            <td><img src="images/productImage/${f.getProduct().getProductImage().getUrl()}" width="300px" height="300px"></td>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <c:if test="${pagination.getCurrentPage()>1}">
                                        <li class="page-item"><a class="page-link" href="FeedbackList?currentpage=1">First</a></li>
                                        <li class="page-item"><a class="page-link" href="FeedbackList?currentpage=${pagination.getCurrentPage()-1}">${pagination.getCurrentPage()-1}</a></li>
                                        </c:if>

                                    <li class="page-item active"><a class="page-link" href="FeedbackList?currentpage=${pagination.getCurrentPage()}">${pagination.getCurrentPage()}</a></li>
                                        <c:if test="${pagination.getCurrentPage()<pagination.getPageCount()}">
                                        <li class="page-item"><a class="page-link" href="FeedbackList?currentpage=${pagination.getCurrentPage()+1}">${pagination.getCurrentPage()+1}</a></li>
                                        <li class="page-item"><a class="page-link" href="FeedbackList?currentpage=${pagination.getPageCount()}">Last</a></li>
                                        </c:if>
